...
upload: cargo-ver
	cd examples && cargo espflash flash --monitor --partition-table esp32/partitions.csv --baud 460800 -f 80M --use-stub --bin esp32-server --target=xtensa-esp32-espidf --release -Zbuild-std=std,panic_abort
